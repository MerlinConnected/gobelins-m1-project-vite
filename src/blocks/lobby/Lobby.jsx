...
import { baseVariants, orchestrate, pageTransitionExit, textAppearRotate, textLineAppear } from '../../core/animation';
...
function Lobby({ className, ...props }) {
  ...
  return (
    <motion.div {...baseVariants} {...pageTransitionExit} className={classNames(styles.wrapper, className)} {...props}>
